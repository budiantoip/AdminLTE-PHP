...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    watch: {
      ...
      files: ["build/less/*.less", "build/less/skins/*.less", "dist/js/app.js","*.html","documentation/**/*.html","pages/**/*.js","pages/**/*.html","*.php","pages/**/*.php"],
      tasks: ["less", "uglify"],
      options: {
        livereload: true
      }
    ...
    less: {
      ...
      development: {
        ...
        files: {
          ...
          "dist/css/bootstrap-tagsinput.min.css": "build/less/bootstrap-tagsinput.less",
          "dist/css/jquery-confirm.min.css": "build/less/jquery-confirm.less",
